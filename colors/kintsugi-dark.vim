" Kintsugi Dark for Neovim, ported from ahatem/vscode-kintsugi
hi clear
if exists("syntax_on")
  syntax reset
endif
let g:colors_name="kintsugi-dark"
...
hi Normal                   guifg=#dddddd guibg=#161618 gui=nocombine,NONE
hi NormalNC                 guifg=#dddddd guibg=NONE    gui=nocombine,NONE
...
" vim-preferred
hi Comment                  guifg=#af9661 guibg=NONE    gui=NONE
hi Constant                 guifg=#939799 guibg=NONE    gui=bold
hi String                   guifg=#98c379 guibg=NONE    gui=nocombine,NONE
hi Character                guifg=#98c379 guibg=NONE    gui=bold
hi Number                   guifg=#819aff guibg=NONE    gui=NONE
hi Boolean                  guifg=#939799 guibg=NONE    gui=bold
hi Float                    guifg=#819aff guibg=NONE    gui=NONE
hi Identifier               guifg=#dddddd guibg=NONE    gui=nocombine,NONE
hi Function                 guifg=#dddddd guibg=NONE    gui=nocombine,NONE
hi Statement                guifg=#dbad49 guibg=NONE    gui=bold
hi Conditional              guifg=#dbad49 guibg=NONE    gui=bold
hi Repeat                   guifg=#dbad49 guibg=NONE    gui=bold
hi Label                    guifg=#939799 guibg=NONE    gui=nocombine,NONE
hi Operator                 guifg=#dddddd guibg=NONE    gui=NONE
hi Keyword                  guifg=#dbad49 guibg=NONE    gui=bold
hi Exception                guifg=#dbad49 guibg=NONE    gui=bold
hi PreProc                  guifg=#dbad49 guibg=NONE    gui=bold
hi Include                  guifg=#dbad49 guibg=NONE    gui=bold
hi Define                   guifg=#dbad49 guibg=NONE    gui=bold
hi Macro                    guifg=#dbad49 guibg=NONE    gui=bold
hi PreCondit                guifg=#dbad49 guibg=NONE    gui=bold
hi Type                     guifg=#939799 guibg=NONE    gui=nocombine,NONE
hi StorageClass             guifg=#dbad49 guibg=NONE    gui=bold,nocombine
hi Structure                guifg=#939799 guibg=NONE    gui=nocombine,NONE
hi Typedef                  guifg=#939799 guibg=NONE    gui=NONE
hi Special                  guifg=#939799 guibg=NONE    gui=bold
hi SpecialChar              guifg=#98c379 guibg=NONE    gui=NONE
hi Tag                      guifg=#939799 guibg=NONE    gui=NONE
hi Delimiter                guifg=#868165 guibg=NONE    gui=NONE
hi SpecialComment           guifg=#af9661 guibg=NONE    gui=bold
hi Debug                    guifg=#819aff guibg=NONE    gui=NONE
hi Underlined               guifg=NONE    guibg=NONE    gui=underline
hi Error                    guifg=#b38f8f guibg=NONE    gui=bold
...
hi htmlH2                   guifg=#8fa3b3 guibg=NONE    gui=bold
hi htmlH3                   guifg=#939799 guibg=NONE    gui=bold
hi htmlH4                   guifg=#819aff guibg=NONE    gui=bold
hi htmlH5                   guifg=#819aff guibg=NONE    gui=NONE
hi htmlH6                   guifg=#819aff guibg=NONE    gui=italic
...
" custom
hi kintsugiClassCombine     guifg=#939799 guibg=NONE    gui=NONE
" Linking -------------------------------------------------------------------
hi clear @variable
hi clear Added
hi clear Changed
